...
export const EVENT_SIGNATURES = {
  'cad83b3c3de3e0f32695b7c585b47e254cacd4fab040794b72adcbaa6a9b75c6': 'new_game',
...
export function decodeEvent(signatureHex: string, dataHex: string, topics: string[]): AnyDecodedEvent | null {
  switch (signatureHex) {
    case 'cad83b3c3de3e0f32695b7c585b47e254cacd4fab040794b72adcbaa6a9b75c6': return { eventType: 'new_game', data: decodeNewGame(dataHex, topics) }
